                ...
                <div class="card">
                    ...
                    <form action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="form-group"><label for="price" class=" form-control-label">Hraga Produk</label>
                                <input type="number" id="price" class="form-control @error('type') is-invalid @enderror"
